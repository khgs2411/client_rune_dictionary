...
- **Iteration**: Iteration 2.5 - InteractionComponent Range Extension & HoverComponent Refactor 🚧 BRAINSTORMING
...
- 🚧 **Task 2**: WebSocket Match Events & Match Loop System (5/5 iterations) ← **CURRENT**
