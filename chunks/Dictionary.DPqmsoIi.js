import{B as L,R as C,P as A,Q as R,S as V,U as D,V as T,c as p,o as b,a as s,y as S,n as w,z as P,h,G as y,W as _,X as m,x as G,F as x,r as E,A as I,Y as q,w as f,d as H,$ as M,H as k,a0 as U,b as O,u as $,s as W,e as Y,_ as Q}from"./index.BCRmze3N.js";import{s as X}from"./index.BSjjLJ9B.js";var J=({dt:t})=>`
.p-togglebutton {
    display: inline-flex;
    cursor: pointer;
    user-select: none;
...
`,ut={root:function(e){var n=e.instance;return["p-selectbutton p-component",{"p-invalid":n.$invalid}]}},dt=L.extend({name:"selectbutton",style:st,classes:ut}),ct={name:"BaseSelectButton",extends:A,props:{options:Array,optionLabel:null,optionValue:null,optionDisabled:null,multiple:Boolean,allowEmpty:{type:Boolean,default:!0},dataKey:null,ariaLabelledby:{type:String,default:null},size:{type:String,default:null}},style:dt,provide:function(){return{$pcSelectButton:this,$parentInstance:this}}};function gt(t,e){var n=typeof Symbol<"u"&&t[Symbol.iterator]||t["@@iterator"];if(!n){if(Array.isArray(t)||(n=K(t))||e){n&&(t=n);var r=0,u=function(){};return{s:u,n:function(){return r>=t.length?{done:!0}:{done:!1,value:t[r++]}},e:function(l){throw l},f:u}}throw new TypeError(`Invalid attempt to iterate non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}var o,a=!0,i=!1;return{s:function(){n=n.call(t)},n:function(){var l=n.next();return a=l.done,l},e:function(l){i=!0,o=l},f:function(){try{a||n.return==null||n.return()}finally{if(i)throw o}}}}function bt(t){return ht(t)||ft(t)||K(t)||pt()}function pt(){throw new TypeError(`Invalid attempt to spread non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function K(t,e){if(t){if(typeof t=="string")return B(t,e);var n={}.toString.call(t).slice(8,-1);return n==="Object"&&t.constructor&&(n=t.constructor.name),n==="Map"||n==="Set"?Array.from(t):n==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)?B(t,e):void 0}}function ft(t){if(typeof Symbol<"u"&&t[Symbol.iterator]!=null||t["@@iterator"]!=null)return Array.from(t)}function ht(t){if(Array.isArray(t))return B(t)}function B(t,e){(e==null||e>t.length)&&(e=t.length);for(var n=0,r=Array(e);n<e;n++)r[n]=t[n];return r}var j={name:"SelectButton",extends:ct,inheritAttrs:!1,emits:["change"],methods:{getOptionLabel:function(e){return this.optionLabel?m(e,this.optionLabel):e},getOptionValue:function(e){return this.optionValue?m(e,this.optionValue):e},getOptionRenderKey:function(e){return this.dataKey?m(e,this.dataKey):this.getOptionLabel(e)},isOptionDisabled:function(e){return this.optionDisabled?m(e,this.optionDisabled):!1},isOptionReadonly:function(e){if(this.allowEmpty)return!1;var n=this.isSelected(e);return this.multiple?n&&this.d_value.length===1:n},onOptionSelect:function(e,n,r){var u=this;if(!(this.disabled||this.isOptionDisabled(n)||this.isOptionReadonly(n))){var o=this.isSelected(n),a=this.getOptionValue(n),i;if(this.multiple)if(o){if(i=this.d_value.filter(function(d){return!_(d,a,u.equalityKey)}),!this.allowEmpty&&i.length===0)return}else i=this.d_value?[].concat(bt(this.d_value),[a]):[a];else{if(o&&!this.allowEmpty)return;i=o?null:a}this.writeValue(i,e),this.$emit("change",{event:e,value:i})}},isSelected:function(e){var n=!1,r=this.getOptionValue(e);if(this.multiple){if(this.d_value){var u=gt(this.d_value),o;try{for(u.s();!(o=u.n()).done;){var a=o.value;if(_(a,r,this.equalityKey)){n=!0;break}}}catch(i){u.e(i)}finally{u.f()}}}else n=_(this.d_value,r,this.equalityKey);return n}},computed:{equalityKey:function(){return this.optionValue?null:this.dataKey},dataP:function(){return R({invalid:this.$invalid})}},directives:{ripple:C},components:{ToggleButton:z}},yt=["aria-labelledby","data-p"];function vt(t,e,n,r,u,o){var a=G("ToggleButton");return b(),p("div",h({class:t.cx("root"),role:"group","aria-labelledby":t.ariaLabelledby},t.ptmi("root"),{"data-p":o.dataP}),[(b(!0),p(x,null,E(t.options,function(i,d){return b(),I(a,{key:o.getOptionRenderKey(i),modelValue:o.isSelected(i),onLabel:o.getOptionLabel(i),offLabel:o.getOptionLabel(i),disabled:t.disabled||o.isOptionDisabled(i),unstyled:t.unstyled,size:t.size,readonly:o.isOptionReadonly(i),onChange:function(g){return o.onOptionSelect(g,i,d)},pt:t.ptm("pcToggleButton")},q({_:2},[t.$slots.option?{name:"default",fn:f(function(){return[S(t.$slots,"option",{option:i,index:d},function(){return[s("span",h({ref_for:!0},t.ptm("pcToggleButton").label),y(o.getOptionLabel(i)),17)]})]}),key:"0"}:void 0]),1032,["modelValue","onLabel","offLabel","disabled","unstyled","size","readonly","onChange","pt"])}),128))],16,yt)}j.render=vt;const mt={class:"dictionary-view min-h-screen bg-gradient-to-br from-slate-900 via-primary-900 to-slate-900"},$t={class:"container mx-auto px-4 pb-12"},wt={class:"flex justify-center mb-12"},_t={class:"cards-grid grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 max-w-7xl mx-auto"},kt={class:"card-header-wrapper relative overflow-hidden h-48"},St=["alt","src"],xt={class:"card-icon absolute top-4 right-4 text-4xl opacity-50 group-hover:opacity-100 transition-opacity"},Bt={class:"text-2xl font-bold text-primary-300 text-center flex items-center justify-center gap-2"},Vt={class:"text-primary-400/80 text-center italic"},Ot={class:"text-color text-center h-20 flex items-center justify-center"},Lt=H({__name:"Dictionary",setup(t){const e=M(),n=k("runes"),r=k([{key:"runes",label:"Runes"},{key:"aspects",label:"Aspects"}]),u=l=>({Generate:"✨",View:"📖",Create:"🔮",Edit:"✏️",Delete:"🗑️"})[l]||"📜",o=l=>({Generate:"pi pi-sparkles",View:"pi pi-eye",Create:"pi pi-plus-circle",Edit:"pi pi-pencil",Delete:"pi pi-trash"})[l]||"pi pi-book",a=l=>({Generate:"Forge Runeability",View:"Browse Collection",Create:"Craft New Rune",Edit:"Modify Rune",Delete:"Destroy Rune"})[l]||l,i=l=>({Generate:"bg-gradient-to-r from-primary-600 to-pink-600 hover:from-primary-700 hover:to-pink-700",View:"bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700",Create:"bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700",Edit:"bg-gradient-to-r from-amber-600 to-orange-600 hover:from-amber-700 hover:to-orange-700",Delete:"bg-gradient-to-r from-red-600 to-rose-600 hover:from-red-700 hover:to-rose-700"})[l]||"bg-primary-600 hover:bg-primary-700",d=k({runes:[{title:"Generate",subtitle:"Generate a new Runeability",content:"Begin the Runeability creation process by selecting the desired Runes.",img:"/client_rune_dictionary/rune_generation.webp"},{title:"View",subtitle:"View Runes",content:"View a list of all existing Runes",hidden:!1,img:"/client_rune_dictionary/rune_get.webp"},{title:"Create",subtitle:"Create a Rune",content:"Create a new Rune",hidden:!1,img:"/client_rune_dictionary/rune_create.webp"},{title:"Edit",subtitle:"Edit a Rune",content:"Edit the properties of a Rune",hidden:!1,img:"/client_rune_dictionary/edit.webp"},{title:"Delete",subtitle:"Delete a Rune",content:"Delete a Rune",hidden:!1,img:"/client_rune_dictionary/rune_delete.webp"}],aspects:[{title:"Create",subtitle:"Create an Aspect",content:"Create an Aspect and assign it to the relevant runes.",img:"/client_rune_dictionary/aspect_create.webp"},{title:"View",subtitle:"View Aspects",content:"View a list of all existing Aspects",hidden:!1,img:"/client_rune_dictionary/aspect_get.webp"},{title:"Edit",subtitle:"Edit an Aspect",content:"Edit the properties of an Aspect.",img:"/client_rune_dictionary/edit.webp"},{title:"Delete",subtitle:"Delete an Aspect",content:"Delete an Aspect",hidden:!1,img:"/client_rune_dictionary/aspect_delete.webp"}]});return(l,g)=>{const F=D("ripple");return b(),p("div",mt,[g[2]||(g[2]=U('<div class="dictionary-header relative py-12 px-4 text-center overflow-hidden" data-v-86059b1f><div class="absolute inset-0 bg-black/30" data-v-86059b1f></div><div class="absolute inset-0 bg-gradient-to-b from-transparent via-primary-900/20 to-transparent" data-v-86059b1f></div><div class="relative z-10" data-v-86059b1f><h1 class="text-5xl md:text-6xl font-bold text-primary-200 mb-4 drop-shadow-lg" data-v-86059b1f>Tome of Knowledge</h1><p class="text-xl text-primary-300/80" data-v-86059b1f>Master the ancient arts of runecraft</p></div></div>',1)),s("div",$t,[s("div",wt,[O($(j),{allowEmpty:!1,"option-value":"key","option-label":"label",modelValue:n.value,"onUpdate:modelValue":g[0]||(g[0]=c=>n.value=c),options:r.value,class:"rpg-select-button"},null,8,["modelValue","options"])]),s("div",_t,[(b(!0),p(x,null,E(d.value[n.value],(c,N)=>(b(),p(x,{key:c.title},[c.hidden?P("",!0):T((b(),I($(X),{key:0,class:w(["rpg-card group transform transition-all duration-300 hover:scale-105 hover:-translate-y-2 hover:shadow-2xl",`card-enter-${N}`])},{header:f(()=>[s("div",kt,[s("img",{alt:c.title,class:"card-image w-full h-full object-cover group-hover:scale-110 transition-transform duration-500",src:c.img??`https://placehold.co/400x200/${$(e).currentTheme.value.split("#")[1]}/FFF`},null,8,St),g[1]||(g[1]=s("div",{class:"card-overlay absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent"},null,-1)),s("div",xt,y(u(c.title)),1)])]),title:f(()=>[s("h3",Bt,[s("i",{class:w(o(c.title))},null,2),Y(" "+y(c.title),1)])]),subtitle:f(()=>[s("p",Vt,y(c.subtitle),1)]),content:f(()=>[s("p",Ot,y(c.content),1)]),footer:f(()=>[O($(W),{label:a(c.title),icon:"pi pi-arrow-right",iconPos:"right",class:w(["w-full rpg-button",i(c.title)])},null,8,["label","class"])]),_:2},1032,["class"])),[[F]])],64))),128))])])])}}}),Rt=Q(Lt,[["__scopeId","data-v-86059b1f"]]);export{Rt as default};
