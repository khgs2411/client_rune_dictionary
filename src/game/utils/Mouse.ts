...
export type MouseEventType = "move" | "down" | "up" | "click" | "rightclick" | "middleclick" | "dragstart" | "drag" | "dragend" | "scroll" | "enter" | "leave" | "pointerlockchange";
...
export class Mouse {
	...
	private handleMouseMove(event: MouseEvent): void {
		...
		this._normalizedPosition.set((newX / this.canvasWidth) * 2 - 1, -(newY / this.canvasHeight) * 2 + 1);
