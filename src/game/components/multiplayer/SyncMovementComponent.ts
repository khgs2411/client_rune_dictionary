...
import { E_NetworkEventCategory } from "@/game/systems/NetworkingService";
...
export class SyncMovementComponent extends GameComponent {
	...
	private syncPosition(): void {
		...
		const positionChanged = currentPos.distanceTo(this.lastSyncedPosition) >= this.positionThreshold;
