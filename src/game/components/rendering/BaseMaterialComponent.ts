...
import { I_MaterialProvider } from "../../common/mesh.types";
 ...
 * ```
 */
export abstract class BaseMaterialComponent<TMaterial extends Material, TConfig extends I_BaseMaterialConfig> extends GameComponent implements I_MaterialProvider {
