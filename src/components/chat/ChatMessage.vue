<template>
	...
	<div v-else class="message" @contextmenu="onContextMenu" @click="onContextMenu">
		<span class="message-information">
			[{{ formattedTime }} - <span class="channel"
				:class="{ 'whisper-indicator': isWhisper, 'error-indicator': isErrorMessage }">{{ channel }}]</span>
		</span>
		<span class="sender"
			:class="{ 'system-indicator': isSystemMessage, 'error-indicator': isErrorMessage, 'generic-indicator': isGenericMessage, 'whisper-indicator': isWhisper }">{{
				sender }}:</span>

		<span class="message-content" :class="{ 'whisper-indicator': isWhisper, 'error-indicator': isErrorMessage }">{{
