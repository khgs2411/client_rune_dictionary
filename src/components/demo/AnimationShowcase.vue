  ...
  <div class="animation-showcase rpg-container">
    ...
    <div class="showcase-grid">
      ...
      <section class="showcase-section">
        ...
        <div class="demo-grid">
          <motion.div
            ref="entranceUp.element"
            :initial="entranceUpPlain.initial"
            :animate="entranceUpPlain.animate"
            :transition="entranceUpPlain.transition"
            class="demo-card">
          ...
          <motion.div
            ref="entranceLeft.element"
            :initial="entranceLeftPlain.initial"
            :animate="entranceLeftPlain.animate"
            :transition="entranceLeftPlain.transition"
            class="demo-card">
          ...
          <motion.div
            ref="entranceScale.element"
            :initial="entranceScalePlain.initial"
            :animate="entranceScalePlain.animate"
            :transition="entranceScalePlain.transition"
            class="demo-card">
          ...
          <motion.div
            ref="entranceFade.element"
            :initial="entranceFadePlain.initial"
            :animate="entranceFadePlain.animate"
            :transition="entranceFadePlain.transition"
            class="demo-card">
      ...
      <section class="showcase-section">
        ...
        <div class="demo-grid">
          <motion.div
            ...
            :transition="toValue(hoverScale.transition)"
          ...
          <motion.div
            ...
            :transition="toValue(hoverLift.transition)"
          ...
          <motion.div
            ...
            :transition="toValue(hoverRotate.transition)"
      ...
      <section class="showcase-section">
        ...
        <div class="stagger-demo">
          <motion.div
            ...
            :transition="item?.transition || { duration: 0.3 }"
            class="stagger-item">
            {{ index + 1 }}
          </motion.div>
        </div>
      ...
      <section class="showcase-section">
        ...
        <div class="loading-demo">
          <motion.div
            ...
            :transition="toValue(loadingAnimation.transition)"
        ...
        <div class="loading-controls">
          <Button 
            @click="toggleLoading" 
            :label="loadingAnimation.isLoading ? 'Stop Loading' : 'Start Loading'" 
            outlined />
        </div>
      </section>
        ...
        <div class="budget-demo">
          <div class="budget-categories">
            <div class="budget-item" v-for="(budget, category) in BUDGETS" :key="category">
              ...
              <motion.div
                :animate="{ x: [0, 20, 0] }"
                :transition="createAnimationConfig(category as AnimationCategory)"
                class="budget-demo-item"
                @click="testBudget(category as AnimationCategory)">
                Test {{ category }}
              </motion.div>
            </div>
          </div>
