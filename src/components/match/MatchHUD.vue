<template>
	...
	<div v-if="isVisible" class="fixed inset-0 pointer-events-none">
		...
		<div class="absolute top-0 right-4 mt-16 pointer-events-auto">
			<StatusPanel entity-type="enemy" :name="enemyName" :level="enemyLevel" :hp="enemyHp" :max-hp="enemyMaxHp" :mp="enemyMp" :max-mp="enemyMaxMp" :atb-progress="enemyAtbProgress" :is-atb-running="isAtbRunning" />
		</div>
