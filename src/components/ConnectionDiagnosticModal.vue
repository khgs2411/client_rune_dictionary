          ...
          <div class="rounded-lg border border-border bg-card p-6 shadow-2xl space-y-4">
            ...
            <div class="text-center space-y-2">
              <div class="mx-auto w-16 h-16 rounded-full bg-destructive/10 flex items-center justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-destructive" fill="none"
              ...
              <p class="text-sm text-muted-foreground">
                Unable to connect to the game server. Please check your browser settings.
              </p>
            </div>
            ...
            <div v-if="!loading" class="space-y-3">
              ...
              <div class="flex items-start gap-3 p-3 rounded-md border" :class="results.webSocket.success
                  ? 'border-green-500/50 bg-green-500/10'
                  : 'border-destructive/50 bg-destructive/10'
                ">
                <div class="flex-shrink-0 mt-0.5">
                  <svg v-if="results.webSocket.success" xmlns="http://www.w3.org/2000/svg"
                    class="h-5 w-5 text-green-500" viewBox="0 0 20 20" fill="currentColor">
                    <path fill-rule="evenodd"
                      d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z"
                      clip-rule="evenodd" />
                  </svg>
                  <svg v-else xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-destructive" viewBox="0 0 20 20"
                    fill="currentColor">
                    <path fill-rule="evenodd"
              ...
              <div v-if="!results.webSocket.success"
                class="rounded-md bg-yellow-500/10 border border-yellow-500/50 p-4">
              ...
              <!-- Countdown Message -->
              <div v-if="!canClose"
                class="flex items-center justify-center gap-2 p-3 rounded-md bg-muted/50 text-sm text-muted-foreground">
            ...
            <div v-else class="text-center py-8">
              <svg class="animate-spin h-8 w-8 mx-auto text-primary" xmlns="http://www.w3.org/2000/svg" fill="none"
                viewBox="0 0 24 24">
            ...
            <div class="flex gap-2 justify-center pt-2">
              ...
              <Button v-if="canClose" @click="handleClose" variant="outline">
                Close
              </Button>
            </div>
          </div>
