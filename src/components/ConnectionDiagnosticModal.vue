            ...
            <div v-if="!loading" class="space-y-3">
              ...
              <div
                ...
                <div class="flex-shrink-0 mt-0.5">
                  <svg
                    v-if="results.webSocket.success"
                    xmlns="http://www.w3.org/2000/svg"
              ...
              <div
                ...
                <ul class="text-sm text-muted-foreground space-y-1.5 ml-6 list-disc">
                  ...
                  <li>
                    <strong>Popup Blockers:</strong> Allow popups for this site in browser settings
                  </li>
                  <li>
                    <strong>Firewall:</strong> Check if your firewall is blocking WebSocket
                    connections
                  </li>
                  <li><strong>VPN/Proxy:</strong> Try disabling VPN or proxy if active</li>
                  <li>
                    <strong>Try:</strong> Use incognito mode or a different browser (Chrome,
                    Firefox, Edge)
                  </li>
                </ul>
              </div>
