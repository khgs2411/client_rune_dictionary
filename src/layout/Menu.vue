				...
				<Tooltip>
					<TooltipTrigger as-child>
						<Button variant="ghost" size="icon" class="h-8 w-8" @click="toggleDebugger">
							<Icon :icon="settings.debug.showWebSocketDebugger ? 'radix-icons:globe' : 'radix-icons:component-none'" class="h-4 w-4" />
						</Button>
					</TooltipTrigger>
					<TooltipContent>
						<p>
							{{ settings.debug.showWebSocketDebugger ? "Hide WebSocket Debugger" : "Show WebSocket Debugger" }}
						</p>
					</TooltipContent>
				</Tooltip>
				<Tooltip>
